...
- Mode Guide: https://github.com/chatman-media/claude-flow-multilang/docs/sparc-${mode.slug}.md
- Batchtools Integration: https://github.com/chatman-media/claude-flow-multilang/docs/batchtools-${mode.slug}.md
`;
}
